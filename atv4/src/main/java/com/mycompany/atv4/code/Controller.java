 ...
 */
import com.mycompany.atv4.model.DaoUsuario;
import com.mycompany.atv4.model.Usuario;
...
public class Controller extends HttpServlet {
    ...
    public boolean login(String _user, String _pass) {
        DaoUsuario da = new DaoUsuario(1, "root", "root");
        Usuario temp = da.buscar(_user);
        return !(temp == null || !(_pass.equals(temp.getSenha())));
    }
